<div id="sidebar" class="span3">
		...
		<ul id="sideManu" class="nav nav-tabs nav-stacked">
			@if(isset($countCart))
      <div class="well well-small"><a id="myCart" href="product_summary.html"><img src="themes/images/ico-cart.png" alt="cart">{{$countCart}} Items in your cart  <!--<span class="badge badge-warning pull-right">$155.00</span>--></a></div>
			@endif
